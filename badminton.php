...
$email_list = "";
$sql = mysqli_query($link, "SELECT * FROM `badminton_list` WHERE username='$user'") or die (mysqli_error($link));;
$number = 0;
...
<title>Jolly V1 - Badminton</title>
...
-->
        <div class="content_box">
          <div>
            <h2>Hello <span style="text-transform:uppercase; color:rgba(96,85,85,1.00)"><?php echo $user;?></span> , here is your BADMINTON contacts:</h2>
          </div>
                ...
                <tbody>
                  <tr>
                    <td align="center" style="height:60px">
                      ...
                      <a href="scripts/export_badminton.php?username=<?php echo $user;?>"><input type="button" name="export" id="export" value="Export to Excel" style="width:auto" /></a>
                  </tr>
                </tbody>
              </table>
            </table>
